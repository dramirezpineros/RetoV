...
public class ReservationRatingControlador {
    ...
    public Optional<ReservationRating>getMensaje(@PathVariable("id") int id){
        return reservationRatingServicio.getCalificacionReserva(id);
    }
    ...
    public boolean delete(@PathVariable("id")int id){
        return reservationRatingServicio.deleteCalificacionReserva(id);
    }

    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public ReservationRating update(@RequestBody ReservationRating calificacionReserva){
        return reservationRatingServicio.update(calificacionReserva);
    }
}
